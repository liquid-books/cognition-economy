# Scraped: https://code.claude.com/docs/en/agent-teams
...
[Agent view](https://code.claude.com/docs/en/agent-view) [Isolate sessions with worktrees](https://code.claude.com/docs/en/worktrees)
...
Metadata: {
  ...
  "charset": "utf-8",
  "twitter:description": "Coordinate multiple Claude Code instances working together as a team, with shared tasks, inter-agent messaging, and centralized management.",
  "og:image:width": "1200",
  "ogDescription": "Coordinate multiple Claude Code instances working together as a team, with shared tasks, inter-agent messaging, and centralized management.",
  "ogUrl": "https://code.claude.com/docs/en/agent-teams",
  "generator": "Mintlify",
  ...
  "og:type": "website",
  "canonical": "https://code.claude.com/docs/en/agent-teams",
  ...
  "next-size-adjust": "",
  "twitter:title": "Orchestrate teams of Claude Code sessions - Claude Code Docs",
  ...
  "og:url": "https://code.claude.com/docs/en/agent-teams",
  "og:title": "Orchestrate teams of Claude Code sessions - Claude Code Docs",
  "og:description": "Coordinate multiple Claude Code instances working together as a team, with shared tasks, inter-agent messaging, and centralized management.",
  ...
  "scrapeId": "019e4fdd-77bf-7784-ab9a-ac05bcafd43b",
  ...
  "proxyUsed": "basic",
  "cacheState": "hit",
  "cachedAt": "2026-05-22T13:08:03.222Z",
  "creditsUsed": 1,
  "concurrencyLimited": true,
  "concurrencyQueueDurationMs": 77
}

...
- Replaced the COLLAPSE-era "one paragraph + pointer" with the standard **"One Exercise, Three Surfaces"** admonition used in ch09/ch10 ("You only need to complete one track… current versions of all three tracks are on the companion page at cognitioneconomy.net/chNN-companion").
...
5. Companion pages assert current-state facts (Shift+Tab, plans directory, Cowork-in-Pro, ≈$20 pricing) **as of Fall 2026 per the audit's landscape table** — these are drafts and should be re-verified against live products before cognitioneconomy.net publication.

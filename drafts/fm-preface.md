---
title: "Preface — Why Now, Why You"
short_title: "Preface"
description: "The window of advantage is narrow and closing. What this book is and what it is not."
label: fm-preface
---

# Preface — Why Now, Why You
...
The professionals who will be most valuable in five years are not the ones with the highest technical credentials. They are the ones who built genuine working fluency with AI systems when the tools were still messy and the manuals were still being written. Those people will have an intuition that cannot be taught from a textbook five years from now. It can only be built now, through repeated contact with the work.
...
The problem is that tools change faster than books can be updated. The prompt tricks that worked in one model generation stop working in the next, and every vendor ships a new generation roughly every year. A book built on tool-specific instructions has a half-life of about eighteen months.
...
This course at Florida Atlantic University is not a survey course. It is not "AI Awareness for Managers." It is a practitioner course — you will build things, break things, and finish with a working AI setup you can use the day after the final exam.

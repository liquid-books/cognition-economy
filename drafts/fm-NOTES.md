# Front Matter — Draft Notes (Aug 2026 revision)

Scope: fm-foreword, fm-preface, fm-who-this-is-for, fm-how-to-read, fm-two-mental-models, fm-setup. All drafts in `drafts/`; originals untouched.

## fm-foreword.md
- **Unchanged** (audit: "Leave alone: Foreword entirely"). Copied verbatim so the drafts set is complete.

## fm-preface.md
- "The specific syntax that worked in ChatGPT 3.5 … GPT-4 … Claude … next quarter" → audit's exact replacement: "The prompt tricks that worked in one model generation stop working in the next, and every vendor ships a new generation roughly every year."
- "cannot be taught from a textbook in 2029" → "cannot be taught from a textbook five years from now."
- "ISM 6427C at Florida Atlantic University" → "This course at Florida Atlantic University" (course number moves to copyright page — see Flags).
- Window-is-closing thesis and all other content preserved.

## fm-who-this-is-for.md
- "$20/month Claude subscription" → "consumer AI subscription" (Move 2/4: role not vendor, no literal price).
...
- Chapter Rhythm, Two Mental Models summary, three-beat structure preserved.

## fm-two-mental-models.md
- IQ-180 claim softened per audit: "These models sit above that threshold" → "Treat the model as sitting somewhere in that range — the exact number is not the point." Kept 180 as the metaphor's name (frontmatter description updated to match: "the 180-IQ mind").
- Amnesia, dark room, flashlight, and everything else preserved verbatim (audit: leave alone).

## fm-setup.md
- **Split per Move 1 / audit before/after example.** All perishables removed from print: Claude Pro $20, claude.ai/download, the desktop-only "MCP tool connections and extended thinking mode" claim, Gemini 2.5 Pro, "Gemini Advanced ($20/month, Google One AI Premium)" (retired plan name), "free until Module 5", code.visualstudio.com URL.
...
## FIGURES-TODO
- None. Front matter contains no figure directives.

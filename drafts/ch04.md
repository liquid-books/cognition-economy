...
:class: note
Before relying on this chapter's specifics, check three things. (1) Visit agentskills.io — is the SKILL.md specification still current, and is your vendor on the adopter list? (2) Ask your assistant whether it can record a demonstration and turn it into a skill; the feature's name and location move between releases. (3) Try to open one of your own skills as a file. If you cannot get at the file, you do not own the skill — move it somewhere you can. Current details live at drlee.io/ch04.
:::

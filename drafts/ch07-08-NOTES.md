...
- **Verify sidebar** — "Is this still true?" admonition present with the audit's question ("What do you already know about me from previous sessions, and where is that stored?") plus memory-settings inspection and DPA re-read; companion pointer cognitioneconomy.net/ch07-companion.
...
- **Vocabulary-drift sidebar** — new "Is this still true? The vocabulary will have drifted" admonition with the two-question test (Did someone else build and maintain it? Can I see and change what it's allowed to touch?) + cognitioneconomy.net/ch08-companion pointer.

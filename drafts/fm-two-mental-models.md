...
description: "LLM as pure IQ (the 180-IQ mind) and the Flashlight Theory by Matty Squarzoni."
...
Here is the correct frame: think of a frontier LLM as a person with an IQ of roughly 180. Einstein is estimated at around 160. Treat the model as sitting somewhere in that range — the exact number is not the point. The point is that it reasons at a level that would be considered genius by any human standard.

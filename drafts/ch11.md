...
:class: tip
This exercise runs on any of the three surface types you have met in this book: a chat assistant, a terminal agent inside an IDE, or an agent-orchestration workspace. The version below uses the chat assistant — the steps are the most durable and work in any tool. Step-by-step versions for the other two surfaces live on the companion page: **drlee.io/ch11**.
:::
...
### Reflection
Write two or three sentences about what you noticed. Did the build-buy-or-manual recommendation match the instinct you walked in with — and if not, what specifically shifted your thinking? And — most importantly — could you imagine handing the brief you just produced to a real engineering team or a no-code platform on Monday morning?

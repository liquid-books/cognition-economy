...
As of this writing every major frontier vendor has a path to ZDR for enterprise customers; the mechanics differ and change often. The companion page at cognitioneconomy.net/ch14-companion keeps a dated comparison. What does not change is the set of questions you put to any vendor, in any year. Run this checklist:
...
3. **Get ZDR in writing** — if your deployment depends on zero retention, confirm the commitment appears in your signed agreement, by name, not in a sales email. The companion page at cognitioneconomy.net/ch14-companion keeps a dated comparison of where the major vendors stand.
:::

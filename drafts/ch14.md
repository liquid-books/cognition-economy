...
The terminal agent's advantage for this exercise is that the audit ends as a *file you own* — a security-posture document living in your own working folder, not a transcript trapped in a chat history. The exact commands for your tool are on the companion page (drlee.io/ch14); what matters here is which decision each step sets.
...
The orchestration workspace adds something the other two surfaces cannot: before you run the audit, you audit the *workspace itself*. The current tool name and the toggle that opens the manager view are on the companion page (drlee.io/ch14).

...
- **cognitioneconomy.net/ch04-companion convention:** audit says `cognitioneconomy.net/chNN-companion`; I used `cognitioneconomy.net/ch04-companion` (no zero-padding). If other chapter agents used `ch04`, harmonize.

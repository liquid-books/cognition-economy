...
Ostrowski's Front-Door Project assembled a cross-functional team: her two intake paralegals, the firm's Chief Compliance Officer Victor Tellman, a senior partner from the litigation group, and an outside consultant the firm had retained to help design the AI workflow. The team committed to a ninety-day pilot.

...
Six months after go-live, both hospitals had settled into the platform. Tidewater's physicians reported that note summarization was faster and discharge instructions were easier to generate. Physician satisfaction scores improved modestly. Administrative hours dropped by an estimated 18%. Dr. Okafor considered the rollout a success — and largely moved on. The tool had been adopted. The problem had been addressed.
...
:::{figure} ../images/ch00-4-muscle-to-cognition.png
:label: fig-ch00-4
:alt: Muscle Economy vs Cognition Economy transition diagram
:width: 80%
:align: center

*From Muscle to Cognition* — The fundamental economic shift this book is about.
:::

:::{figure} ../images/ch00-5-industrial-revolution-timeline.png
:label: fig-ch00-5
:alt: Industrial Revolution timeline of key milestones
:width: 80%
:align: center

*The Industrial Revolution Timeline* — 140 years of muscle-augmentation milestones.
:::

:::{figure} ../images/ch00-6-business-model-reset.png
:label: fig-ch00-6
:alt: Business model comparison pre- and post-Industrial Revolution
:width: 80%
:align: center

*The Business Model Reset* — Craft economy vs factory economy, side by side.
:::

:::{figure} ../images/ch00-7-ai-revolution-timeline.png
:label: fig-ch00-7
:alt: AI Revolution timeline from the Transformer paper to autonomous agents
:width: 80%
:align: center

*The AI Revolution Timeline (a fixed window: 2017 to press time)* — From Transformer paper to autonomous agents in under a decade.
:::

:::{figure} ../images/ch00-8-cognitive-labor-spectrum.png
:label: fig-ch00-8
:alt: Spectrum of cognitive tasks and AI automation likelihood
:width: 80%
:align: center

*The Cognitive Labor Spectrum* — Which tasks AI can take, and which still need you.
:::

:::{figure} ../images/ch00-9-renting-cognition-model.png
:label: fig-ch00-9
:alt: Pay-per-use AI cognition model like a utility
:width: 80%
:align: center

*Renting Cognition* — Intelligence as a utility: pay for what you use, scale at will.
:::

:::{figure} ../images/ch00-10-builders-question-framework.png
:label: fig-ch00-10
:alt: The Builder's Question decision framework flowchart
:width: 80%
:align: center

*The Builder's Question Framework* — Build, buy, or automate? A decision tree for every cognitive task.
:::

...
3. Select three models from the dropdowns — use **Claude**, **GPT-4o**, and **Gemini Pro** if available.
...
*Choosing Your Model* — GPT-4, Claude, and Gemini compared across the tasks that matter to business people.
:::

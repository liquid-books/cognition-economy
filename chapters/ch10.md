...
When you tell the lead to spawn the team, name the teammates. Not "spawn three teammates." Say "spawn Casey for competitor research, Devi for customer themes, and Atlas for internal gaps." Predictable names mean you can address them later by name. "Ask Devi if she's seen the same pattern Atlas just surfaced." Naming makes the team manageable instead of anonymous.
:::
...
She spun up a three-teammate team with a lead. She named them deliberately: Casey on competitors, Devi on customer feedback, Atlas on the internal gap analysis. She gave each teammate a clear initial brief and the same access to the company's research drive. She told the lead that Casey and Devi's findings should inform Atlas's gap analysis as they emerged, not at the end. She set a goal condition: *the one-page strategic brief is written, sourced, and reviewed by every teammate; the shared task list is empty; the team is cleaned up.*

The tension Priya faced was not whether to use a team. She knew the work was genuinely parallel. The tension was structural. Should Casey, Devi, and Atlas be peers reporting to a lead, with lateral messaging between them? Or should they be sub-agents reporting up to her main session, with no lateral communication? The peer model promised richer synthesis — Atlas's gap analysis would benefit from seeing Casey's competitor findings as they arrived, not in a packaged report at the end. The sub-agent model promised lower token cost and simpler coordination. With 90 minutes until the CEO's pre-read window opened and four pieces of work in flight, every decision about structure had a cost.

By 10:47 a.m., Casey had identified two competitor pivots that materially changed the gap analysis, and Atlas — who had received Casey's interim findings via direct message at 10:31 — had restructured his analysis around them. By 11:30 a.m., Devi's customer feedback synthesis had pulled out three themes that Casey's competitor sweep had not surfaced, and the lead had folded those into the brief. At 11:43 a.m., the goal evaluator confirmed the condition was met, the team cleaned itself up, and Priya read the final brief twice before walking into the conference room at 11:55 a.m.

...
## The Skill Categories Every Business Professional Needs

:::{figure} ../images/ch04-skill-categories.png
:label: fig-ch04-skill-categories
:alt: Six categories of AI skills for business professionals
:width: 80%
:align: center

*Skill Categories* — Six families of tasks. Every professional has recurring work in at least four of them. That is where your first skills belong.
:::

Start by looking at your own work through this lens: what do you do repeatedly that follows a predictable pattern?

That is not a rhetorical question. Sit with it.

Most professional work, when examined honestly, is about 30% genuinely novel problems and about 70% variations on tasks you have done before. The 30% is where your expertise lives. The 70% is where AI skills belong.

Here are the categories where skills deliver the highest return:

**Research Skills** — Anything that requires gathering, synthesizing, or summarizing information on a topic, a person, or a company. A *Pre-Call Briefing* skill that takes a name and returns a structured intelligence brief. A *Market Landscape* skill that takes an industry vertical and returns a competitive summary. A *Trend Spotter* skill that takes a topic and returns the three most significant recent developments.

**Writing Skills** — Any document, message, or content that follows a recognizable structure. An *Email Response* skill that takes an incoming email and drafts a reply in your voice. A *Meeting Follow-Up* skill that takes bullet-point notes and returns a formatted action-item email. A *Proposal Outline* skill that takes a client name and a problem statement and returns a draft structure.

**Analysis Skills** — Pattern recognition and interpretation applied to data, documents, or decisions. A *Deal Scorer* skill that takes a lead's information and rates it against your ideal customer profile. A *Contract Redliner* skill that takes a contract and flags unusual or unfavorable terms. A *Report Distiller* skill that takes a long document and extracts the five things that actually matter.

**Communication Skills** — Translating complex information into clear, audience-appropriate messaging. A *Jargon Translator* skill that takes technical content and rewrites it for a non-expert audience. A *Board Summary* skill that takes operational detail and returns executive-level narrative. A *Client Update* skill that takes project notes and returns a professional status communication.

**Decision Skills** — Structured frameworks applied to choices. A *Decision Coach* skill that takes a decision and returns pros, cons, second-order effects, and a recommendation. A *Risk Spotter* skill that takes a plan and returns the three most likely points of failure. A *Prioritizer* skill that takes a list of tasks and ranks them by impact and urgency.

**Workflow Skills** — Tasks that happen in sequence that can be partially or fully automated. A *Lead Processor* skill that takes a new contact and creates a structured CRM entry. A *Content Repurposer* skill that takes a long-form piece and extracts three shorter formats from it.
...
*Your Skill Library* — This is what you are building. Not a collection of tools you occasionally use. A workforce you deploy every day.
:::

You do not build all of these at once. You build them one at a time, starting with the task that costs you the most time right now. The library grows as your work does.

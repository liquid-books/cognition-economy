...
## The Disciplines at Full Stretch: Deep Research Modes

Here is a question that tests everything you just learned.

What happens when you hand an AI a hard question and thirty minutes of unsupervised time?

Not a prompt-and-response exchange. Not a conversation. A *commission*: the AI writes its own research plan, runs dozens or hundreds of web searches, reads what it finds, notices gaps, searches again, cross-references its own findings — and returns with a structured, cited report that can run to several thousand words.

That is **deep research** — the long-running autonomous research mode that is now standard equipment in every major AI product:

- **Claude research mode** (Anthropic) — a **Research** toggle on the chat input at claude.ai; requires a paid plan. Claude runs multi-pass searches across the web and, if you have connected them, your Google Workspace data — the connectors from Chapter 3 feeding the disciplines of Chapter 5.
- **Gemini Deep Research** (Google) — selectable in the Gemini prompt bar; shows you its research plan *before* it runs and lets you edit the plan. Typically the fastest of the three.
- **ChatGPT deep research** (OpenAI) — a **Deep research** option in ChatGPT's composer tools; the slowest and often the most exhaustive, with runs that can take ten to thirty minutes.

Why does this belong in the six-disciplines chapter? Because a deep research run is the six floors compressed into a single transaction. There is no conversation to steer, no follow-up to clarify, no mid-course correction. Everything the AI will know about your intent must be engineered *into the brief, up front*. Prompt engineering, context engineering, and a dash of memory engineering — spent in five minutes of writing, leveraged across thirty minutes of autonomous work.

:::{figure} ../images/ch05-deep-research.png
:label: fig-ch05-deep-research
:alt: A deep research run — one written brief fanning out into dozens of autonomous searches and converging into a single cited report
:width: 80%
:align: center

*One Brief, Hundreds of Searches* — In a conversation, you steer as you go. In a deep research run, all your steering happens before it starts. The brief is the whole game.
:::

**When extended autonomous research is the right tool.** Use deep research when the question is genuinely open-ended, spans many sources, and would cost you two-plus hours of manual reading: market landscapes, competitor analyses, regulatory overviews, vendor comparisons, literature scans. Do not use it for questions with one findable answer (ordinary search is faster), for questions about your private data alone (a connector conversation handles that), or for anything you need in the next ninety seconds.

**How to brief it.** A deep research brief is a scope-of-work document, not a question. The four components of a strong prompt from Discipline One still apply — but three additions matter at this scale:

- **Boundaries** — what is in scope and, explicitly, what is *out*. "US market only. Exclude enterprise vendors above $1B revenue. Last 24 months only."
- **Source guidance** — what counts as credible for this question. "Prefer primary sources: company filings, pricing pages, regulatory documents. Flag anything sourced only from blogs."
- **Decision context** — what you will *do* with the report. An AI that knows you are choosing between three CRM vendors writes a different report than one that thinks you want a CRM overview.

**How to audit what comes back.** This is the discipline most people skip, and it is where deep research either becomes a superpower or a liability. A deep research report arrives looking authoritative: confident prose, numbered citations, professional structure. Some of those citations will not say what the report claims they say. A few may not support the claim at all. The verification discipline from Chapter 1 — check the citation, read the source, confirm the claim — is not optional here; it is the price of admission. The rule: **a deep research report is a draft by a fast, tireless, occasionally overconfident junior analyst. You are the senior partner. Partners check the footnotes.**

:::{admonition} The Autonomy-Verification Tradeoff
:class: warning
The more autonomously an AI works, the more verification its output deserves — because nobody was watching while it worked. A chat response you steered sentence by sentence needs a skim. A thirty-minute unsupervised research run needs an audit. Scale your verification to the autonomy you granted.
:::

### Try It: Commission and Audit One Deep Research Run (60–75 minutes, most of it unattended)

**What you need:** a paid account on any one of Claude (claude.ai), Gemini (gemini.google.com), or ChatGPT (chatgpt.com) — and one real business question you actually care about. Not a test question. Something whose answer you would genuinely use: a market you are considering, a tool your team might buy, a competitor you need to understand.

**Part 1 — Find the mode (2 minutes)**

1. **In Claude:** open claude.ai, start a new chat, and look at the row of icons on the prompt input box. Click the tools/settings icon and toggle **Research** on. The input area will indicate research mode is active. *(If you do not see it, check that you are on a paid plan — the label and icon placement may vary by version.)*
2. **In Gemini:** open gemini.google.com and look at the prompt bar. Select **Deep Research** — it appears either as a chip below the input box or in the model/tools selector. You will know it is active when the interface says so above or inside the input.
3. **In ChatGPT:** open chatgpt.com, click the **+** or tools icon in the message composer, and choose **Deep research** from the menu.

**Part 2 — Write the brief (10 minutes; do not rush this)**

4. In a separate document, draft your brief using this skeleton, then paste it in:

> *"Research question: [one sentence — the decision-relevant question].*
> *Why I am asking: [one sentence — the decision this feeds].*
> *In scope: [markets, timeframes, segments].*
> *Out of scope: [explicitly excluded].*
> *Sources: prefer [primary sources relevant to your question]; flag any claim supported only by low-quality sources.*
> *Deliverable: a structured report with an executive summary, a findings section organized by [your preferred structure], and a full citation list. Cite a source for every factual claim."*

5. Submit it. **In Gemini specifically:** before running, Gemini shows you its research *plan* — a numbered list of what it intends to investigate. Read it, click **Edit plan** if it missed something, then approve. (Claude and ChatGPT may ask one or two clarifying questions instead — answer them; those answers are the last steering input you get.)

**Part 3 — Wait, then read (5–30 minutes of waiting)**

6. Expect Gemini to finish in roughly 5–15 minutes, Claude in a similar window, and ChatGPT in 10–30. You will see a progress indicator; you do not need to keep the tab focused. Go do something else.
7. When the report arrives, read the executive summary first, then skim the structure, then read in full. Note how many sources it consulted — the report will list them, often dozens.

**Part 4 — The citation audit (20 minutes; this is the actual exercise)**

8. Pick the **five most decision-relevant claims** in the report — the ones you would act on. For each, open the cited source and apply the Chapter 1 verification discipline: Does the source exist? Does it actually contain the claim? Is it primary or secondhand? Is it current?
9. Build this audit table:

| # | Claim in report | Cited source | Source says this? (Yes / Partly / No) | Source quality (Primary / Secondary / Weak) | Verdict |
|---|---|---|---|---|---|

10. Fill in all five rows. Expect at least one "Partly." If all five come back clean, audit three more — a 100% clean audit on the first five is worth confirming, not assuming.

**Your deliverable:** Submit three things: (1) the full deep research report, (2) your completed citation audit table, and (3) exactly two sentences on what the report got wrong or overstated — and if the audit found nothing wrong, two sentences on which claim you trust *least* and why.

*Fallback:* If you have no paid plan on any of the three, Perplexity's research mode (perplexity.ai) offers a free tier with a limited number of deep research runs per day — the brief, the wait, and the audit work identically.
...
<!-- NEW IMAGES NEEDED:
- ch05-deep-research.png — A single written brief at the left fanning out into dozens of parallel search/read threads (a widening funnel of sources), then converging at the right into one structured, cited report; small clock icon indicating a 5–30 minute autonomous run; visual contrast with a back-and-forth chat bubble exchange above it.
-->
